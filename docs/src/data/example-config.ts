...
export const exampleConfig: Record<string, ExamplePageConfig> = {
  ...
  'orszag-tang-vortex': { category: 'Nonlinear MHD', setupTitle: 'Early nonlinear evolution of crossed vortices', plotTitle: 'Density and magnetic field lines in the Orszag–Tang vortex', plotAlt: 'Density and magnetic field lines in the Orszag–Tang vortex' },
