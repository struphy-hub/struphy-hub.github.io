...
export async function GET() {
  const paths = [
    '/', '/examples/', '/models/', '/propagators/', '/domains/', '/equilibria/', '/perturbations/', '/backgrounds/', '/simulation/', '/numerics/', '/feec/', '/time-integration/', '/kernels/', '/implementation/', '/search/', '/citation/', '/team/', '/contact/',
